...
public class Waiter {
    ...
    public static void setDriver (WebDriver driver) {
        jsWaitDriver = driver;
        jsWait = new WebDriverWait(jsWaitDriver, 100);
        jsExec = (JavascriptExecutor) jsWaitDriver;
    }

    //Wait for JQuery Load
    public static void waitForJQueryLoad() throws InterruptedException {
...
//            System.out.println("ANGULAR is Ready!");
    ...
    public static void waitUntilJSReady() {
        WebDriverWait wait = new WebDriverWait(jsWaitDriver,100);
        JavascriptExecutor jsExec = (JavascriptExecutor) jsWaitDriver;
...
//            System.out.println("Angular is not defined on this site!");
    ...
    public static void waitJQueryAngular() throws InterruptedException {
